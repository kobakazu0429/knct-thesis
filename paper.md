...
そこでブラウザ上で完結する学習環境を構築、提案する。
これは、各々の PC へ開発環境を用意する必要がなくなりプログラミングを始める壁を低くすることで、自主学習を促すものである。
...
これらの学習環境で学習した結果として、学生間における習得度のバラツキが抑えられるとともに、実験実習などへの理解を深めることも可能だろう。
